...
async def generate_sticker(
    ...
    """
    Возвращает PNG для терморинтера (400x640 px, что при 200 DPI = 50.8x81.2 мм)
    """
    ...
    # Шрифты (можно скорректировать путь под вашу систему)
    try:
    ...
    # Название сервиса или ФИО мастера
    if service_name:
        title = service_name
    else:
    ...
    # Мастер (если сервис показали, то просто имя)
